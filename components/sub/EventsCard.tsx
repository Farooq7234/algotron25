...
const EventsCard: React.FC<EventsCardProps> = ({ title, imageSrc, name, href }) => {
  return (
    <div className="text-white px-4 py-10">
      ...
      <Link href={href}>
        <div className="relative rounded-xl overflow-hidden shadow-xl hover:scale-[1.02] transition-transform duration-300 ease-in-out bg-gradient-to-r from-[#3a0ca3] via-[#7209b7] to-[#f72585] p-5 max-w-3xl mx-auto">
